...
const actionTypeIcons: Record<SocialAction["actionType"], typeof MessageSquare> = {
  post: MessageSquare,
  comment: MessageSquare,
  follow: Users,
  create_submolt: Users,
  dm: MessageSquare,
};
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 text-xs text-zinc-500 mb-2">
        <span className="rounded px-1.5 py-0.5 bg-zinc-700 text-zinc-400">
          Social · {item.actionType.replace(/_/g, " ")}
        </span>
